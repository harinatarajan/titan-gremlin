...
sed -i "s/titan-berkeleyje-server.properties/titan-cassandra-es.properties/g" conf/gremlin-server/gremlin-server.yaml
...
index.search.hostname=$ELASTICSEARCH_PORT_9200_TCP_ADDR
index.search.elasticsearch.client-only=false" > conf/gremlin-server/titan-cassandra-server.properties
